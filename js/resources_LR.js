...
var v_commands = [
  ...
  "Yes. \"Friend\", \"Mellon\" in Quenya, is the word that opened the Mines of Moria when Gandalf said it. Now, here goes another riddle:<div style=\"text-align: center;\"><br><br>I, we are a crazy bunch, there is many of me, of us. Exactly m(5:9).<br>What is my name?<div style=\"color: white;\">TXkgbmFtZSBpcyBMZWdpb24sIGZvciB3ZSBhcmUgbWFueS4g</div></div>",
  "You are good as hell. And I'm tired of making up riddles. So, here is the last one:<div style=\"text-align: center;\"><br>There is a monster of monsters created by the prince of horror? It creeps in the darkness, terifying. It is calling. What is it?</div><br>When you get it right, just exit The Command Line and you can leave. I'm bored... Fuck off",
